...
class Grid:
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        #print('self.width in grid class', self.width)
    ...
    def place_wall(self, x, y, obj_type=Wall):
        self.set(x, y, obj_type())
...
class MiniGridEnv(gym.Env):
    ...
    def reset(self):
        ...
        print('before self._gen_grid(self.width, self.height is called')
    ...
    def step(self, action):
        ...
        if debug:
            print(f'the agent is currently as {self.agent_pos}')
        fwd_pos = self.front_pos
        if debug:
            print(f'action {action} lead to the next state {fwd_pos}')
