...
class tabular_agent():    
    ...
    def step(self, state, action_index, action_movement, num_time_steps, env): #should return next_state, reward, done
        ...
        reward, done = env.check_reward(next_state, num_time_steps)
        # print('reward', reward)
        # print('done', done)
